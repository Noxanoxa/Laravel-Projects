                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="comment_able" class="form-control">
                            <option
                                value="0" {{ old('comment_able', $post->comment_able) == '0' ? 'selected' : '' }}>{{__('Backend/posts.no')}}</option>
                            <option
                                value="1" {{ old('comment_able', $post->comment_able) == '1' ? 'selected' : '' }}>{{__('Backend/posts.yes')}}</option>
                        </select>
