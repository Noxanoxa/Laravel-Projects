        ...
        <div class="card-body">
            <form method="post" action="{{route('admin.supervisors.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{old('name')}}" class="form-control"
                                   placeholder="{{ __('Backend/supervisors.ur_name') }}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" value="{{old('username')}}" class="form-control"
                                   placeholder="{{ __('Backend/supervisors.ur_username') }}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{old('email')}}" class="form-control"
                                   placeholder="{{ __('Backend/supervisors.ur_email') }}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile" value="{{old('mobile')}}" class="form-control"
                                   placeholder="{{ __('Backend/supervisors.ur_mobile') }}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control"
                                   placeholder="{{ __('Backend/supervisors.ur_password') }}">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="bio" class="form-control"
                                      placeholder="{{ __('Backend/supervisors.ur_bio') }}">{{old('bio')}}</textarea>
                ...
                <div class="form-group pt-4">
                    <button type="submit" class="btn btn-primary">{{__('Backend/supervisors.create_supervisor')}}</button>
                </div>
            </form>
        </div>
    </div>
