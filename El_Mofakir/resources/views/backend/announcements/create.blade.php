        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <textarea name="description" class="form-control" placeholder="{{ __('Backend/announcements.ur_description')}}">{!! old('description') !!}</textarea>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea name="description_en" class="form-control" placeholder="{{ __('Backend/announcements.ur_description')}}">{!! old('description_en') !!}</textarea>
