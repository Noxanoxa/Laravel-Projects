...
class ProfessionalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.professionals.index', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.professionals.index')->with([
    ...
    public function show($id)
    {
        ...
        if ($user) {
            return view('backend.professionals.show', compact('user'));
        }
    ...
    public function edit($id)
    {
        ...
        if ($user) {
            return view('backend.professionals.edit', compact('user'));
        }
