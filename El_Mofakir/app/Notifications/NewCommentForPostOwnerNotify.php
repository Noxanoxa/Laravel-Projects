...
class NewCommentForPostOwnerNotify extends Notification implements ShouldQueue, ShouldBroadcast
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->line('There is new comment from ' . $this->comment->name . ' for your post ' . $this->comment->post->title . '.')
            ->action('Go to your post ', route('users.comment.edit', $this->comment->id)) // Ensure this route name is correct
            ->line('Thank you for using ElMofakir System');
    }
