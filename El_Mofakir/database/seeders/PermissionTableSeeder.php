...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $manageIssues = Permission::create(['name' => 'manage_issues', 'display_name' => 'الارقام', 'description' => 'إدارة الارقام', 'display_name_en' => 'Issues', 'description_en' => 'Manage Issues', 'route' => 'issues', 'module' => 'issues', 'as' => 'issues.index', 'icon' => 'fas fa-book', 'parent' => $manageVolumes->id, 'parent_original' => '0', 'appear' => '0', 'ordering' => '15',]);
        $manageIssues->parent_show = $manageIssues->id;$manageIssues->save();
        $showIssues = Permission::create(['name' => 'show_issues', 'display_name' => 'عرض الارقام', 'description' => 'عرض الارقام', 'display_name_en' => 'Show Issues', 'description_en' => 'Show Issues', 'route' => 'issues', 'module' => 'issues', 'as' => 'issues.index', 'icon' => 'fas fa-book', 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '1', 'ordering' => '0',]);
        $createIssues = Permission::create(['name' => 'create_issues', 'display_name' => 'إنشاء رقم', 'description' => 'إنشاء رقم جديدة', 'display_name_en' => 'Create Issue', 'description_en' => 'Create a new issue', 'route' => 'issues/create', 'module' => 'issues', 'as' => 'issues.create', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
        $displayIssues = Permission::create(['name' => 'display_issues', 'display_name' => 'عرض الرقم', 'description' => 'عرض تفاصيل الرقم', 'display_name_en' => 'Show Issue', 'description_en' => 'Show Issue', 'route' => 'issues/{issues}', 'module' => 'issues', 'as' => 'issues.show', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
        $updateIssues = Permission::create(['name' => 'update_issues', 'display_name' => 'تحديث الرقم', 'description' => 'تحديث تفاصيل الرقم', 'display_name_en' => 'Update Issue', 'description_en' => 'Update issue details', 'route' => 'issues/{issues}/edit', 'module' => 'issues', 'as' => 'issues.edit', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
        $destroyIssues = Permission::create(['name' => 'delete_issues', 'display_name' => 'حذف الرقم', 'description' => 'حذف الرقم', 'display_name_en' => 'Delete Issue', 'description_en' => 'Delete issue', 'route' => 'issues/{issues}', 'module' => 'issues', 'as' => 'issues.delete', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
