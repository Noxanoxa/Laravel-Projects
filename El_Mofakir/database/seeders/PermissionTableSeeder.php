...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //  VOLUMES
        $manageVolumes = Permission::create(['name' => 'manage_volumes', 'display_name' => 'الأعداد', 'description' => 'إدارة الأعداد', 'display_name_en' => 'Volumes', 'description_en' => 'Manage Volumes', 'route' => 'volumes', 'module' => 'volumes', 'as' => 'volumes.index', 'icon' => 'fas fa-book', 'parent' => '0', 'parent_original' => '0', 'appear' => '1', 'ordering' => '10',]);
        $manageVolumes->parent_show = $manageVolumes->id;$manageVolumes->save();
        $showVolumes = Permission::create(['name' => 'show_volumes', 'display_name' => 'عرض الأعداد', 'description' => 'عرض الأعداد', 'display_name_en' => 'Show Volumes', 'description_en' => 'Show Volumes', 'route' => 'volumes', 'module' => 'volumes', 'as' => 'volumes.index', 'icon' => 'fas fa-book', 'parent' => $manageVolumes->id, 'parent_show' => $manageVolumes->id, 'parent_original' => $manageVolumes->id, 'appear' => '1', 'ordering' => '0',]);
        $createVolumes = Permission::create(['name' => 'create_volumes', 'display_name' => 'إنشاء عدد', 'description' => 'إنشاء عدد جديدة', 'display_name_en' => 'Create Volume', 'description_en' => 'Create a new volume', 'route' => 'volumes/create', 'module' => 'volumes', 'as' => 'volumes.create', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageVolumes->id, 'parent_original' => $manageVolumes->id, 'appear' => '0', 'ordering' => '0',]);
        $displayVolumes = Permission::create(['name' => 'display_volumes', 'display_name' => 'عرض العدد', 'description' => 'عرض تفاصيل العدد', 'display_name_en' => 'Show Volume', 'description_en' => 'Show Volume', 'route' => 'volumes/{volumes}', 'module' => 'volumes', 'as' => 'volumes.show', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageVolumes->id, 'parent_original' => $manageVolumes->id, 'appear' => '0', 'ordering' => '0',]);
        $updateVolumes = Permission::create(['name' => 'update_volumes', 'display_name' => 'تحديث العدد', 'description' => 'تحديث تفاصيل العدد', 'display_name_en' => 'Update Volume', 'description_en' => 'Update volume details', 'route' => 'volumes/{volumes}/edit', 'module' => 'volumes', 'as' => 'volumes.edit', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageVolumes->id, 'parent_original' => $manageVolumes->id, 'appear' => '0', 'ordering' => '0',]);
        $destroyVolumes = Permission::create(['name' => 'delete_volumes', 'display_name' => 'حذف العدد', 'description' => 'حذف العدد', 'display_name_en' => 'Delete Volume', 'description_en' => 'Delete volume', 'route' => 'volumes/{volumes}', 'module' => 'volumes', 'as' => 'volumes.delete', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageVolumes->id, 'parent_original' => $manageVolumes->id, 'appear' => '0', 'ordering' => '0',]);

        // ISSUES Numbers that is subchild from Volumes
        $manageIssues = Permission::create(['name' => 'manage_issues', 'display_name' => 'الأعداد', 'description' => 'إدارة الأعداد', 'display_name_en' => 'Issues', 'description_en' => 'Manage Issues', 'route' => 'issues', 'module' => 'issues', 'as' => 'issues.index', 'icon' => 'fas fa-book', 'parent' => $manageVolumes->id, 'parent_original' => '0', 'appear' => '0', 'ordering' => '15',]);
        $manageIssues->parent_show = $manageIssues->id;$manageIssues->save();
        $showIssues = Permission::create(['name' => 'show_issues', 'display_name' => 'عرض الأعداد', 'description' => 'عرض الأعداد', 'display_name_en' => 'Show Issues', 'description_en' => 'Show Issues', 'route' => 'issues', 'module' => 'issues', 'as' => 'issues.index', 'icon' => 'fas fa-book', 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '1', 'ordering' => '0',]);
        $createIssues = Permission::create(['name' => 'create_issues', 'display_name' => 'إنشاء عدد', 'description' => 'إنشاء عدد جديدة', 'display_name_en' => 'Create Issue', 'description_en' => 'Create a new issue', 'route' => 'issues/create', 'module' => 'issues', 'as' => 'issues.create', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
        $displayIssues = Permission::create(['name' => 'display_issues', 'display_name' => 'عرض العدد', 'description' => 'عرض تفاصيل العدد', 'display_name_en' => 'Show Issue', 'description_en' => 'Show Issue', 'route' => 'issues/{issues}', 'module' => 'issues', 'as' => 'issues.show', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
        $updateIssues = Permission::create(['name' => 'update_issues', 'display_name' => 'تحديث العدد', 'description' => 'تحديث تفاصيل العدد', 'display_name_en' => 'Update Issue', 'description_en' => 'Update issue details', 'route' => 'issues/{issues}/edit', 'module' => 'issues', 'as' => 'issues.edit', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
        $destroyIssues = Permission::create(['name' => 'delete_issues', 'display_name' => 'حذف العدد', 'description' => 'حذف العدد', 'display_name_en' => 'Delete Issue', 'description_en' => 'Delete issue', 'route' => 'issues/{issues}', 'module' => 'issues', 'as' => 'issues.delete', 'icon' => null, 'parent' => $manageVolumes->id, 'parent_show' => $manageIssues->id, 'parent_original' => $manageIssues->id, 'appear' => '0', 'ordering' => '0',]);
